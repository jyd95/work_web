...
<body>
	<div class="container">
		...
		<form action="result.jsp" method="POST">
			...
			<input type="text" id="username" name="username" value="요네">
			<br><br>
			...
			<hr>
			<label>좋아하는 색을 선택하시오</label>
			<input type="radio" id="color1" name="favoritColor" value="빨강">
		 	<label for="color1">빨강</label>
			<input type="radio" id="color2" name="favoritColor" value="파랑">
		 	<label for="color2">파랑</label>
			<input type="radio" id="color3" name="favoritColor" value="초록">
